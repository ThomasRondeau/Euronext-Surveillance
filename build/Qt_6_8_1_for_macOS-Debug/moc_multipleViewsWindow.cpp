...
static constexpr auto qt_meta_stringdata_ZN19MultipleViewsWindowE = QtMocHelpers::stringData(
    "MultipleViewsWindow",
    "changePage",
    "",
    "index"
...
Q_CONSTINIT static const uint qt_meta_data_ZN19MultipleViewsWindowE[] = {
...
Q_CONSTINIT const QMetaObject MultipleViewsWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19MultipleViewsWindowE.offsetsAndSizes,
    qt_meta_data_ZN19MultipleViewsWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19MultipleViewsWindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MultipleViewsWindow, std::true_type>,
        // method 'changePage'
...
void *MultipleViewsWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19MultipleViewsWindowE.stringdata0))
