...
DataAnalystWindow::DataAnalystWindow(QWidget *parent) : QWidget(parent) {
    ...
    connect(logoutButton, &QPushButton::clicked, this, &DataAnalystWindow::goToLogin);
}

void DataAnalystWindow::goToLogin() {
    hide();
